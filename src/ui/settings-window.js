document.addEventListener('DOMContentLoaded', () => {    
    ...
    const claudeCliCommandInput = document.getElementById('claudeCliCommand');
    ...
    const loadSettingsIntoUI = (settings) => {
        ...
        if (claudeCliCommandInput) claudeCliCommandInput.value = settings.claudeCliCommand || '';
    ...
    const saveSettings = () => {
        ...
        if (claudeCliCommandInput) settings.claudeCliCommand = claudeCliCommandInput.value;
    ...
    const updateLlmFieldStates = () => {
        ...
        const claudeGroup = document.getElementById('claudeCodeFields');

        if (geminiGroup) geminiGroup.style.display = provider === 'gemini' ? '' : 'none';
        if (claudeGroup) claudeGroup.style.display = provider === 'claude-code' ? '' : 'none';

        if (geminiKeyInput) geminiKeyInput.disabled = provider !== 'gemini';
        if (claudeCliCommandInput) claudeCliCommandInput.disabled = provider !== 'claude-code';
    };
